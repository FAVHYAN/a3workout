 ...
 * loftwitter Class
 */	
class leocustomhome extends Module
{
	/**
    ...
    */
	function __construct(){
		$this->name = 'leocustomhome';
		parent::__construct();			
		$this->author = 'leotheme';				
		$this->version = '1.1';
		$this->displayName = $this->l('Display Custom Content Bottom HTML');
    ...
    */
	function install(){
		if (!parent::install())
			return false;
		if(!$this->registerHook('DisplayContentBottom'))
			return false;
		return true;
	}
	/*
    ...
    */	
	...
	private function _getFormConfig(){
	    ...
	    ob_start();
	    include_once dirname(__FILE__).'/config/leocustomhome.php'; 
