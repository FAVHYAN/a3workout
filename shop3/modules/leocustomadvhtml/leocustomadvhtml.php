 ...
 * loftwitter Class
 */	
class leocustomadvhtml extends Module
{
	/**
    ...
    */
	function __construct(){
		$this->name = 'leocustomadvhtml';
		parent::__construct();			
		$this->author = 'leotheme';				
		$this->version = '1.1';
		$this->displayName = $this->l('Display Custom Adv promotion HTML');
    ...
    */
	function install(){
		if (!parent::install())
			return false;
		if(!$this->registerHook('DisplayPromoteTop'))
			return false;
		return true;
	}
	/*
	...
	function contentDefault() {
		foreach( $this->_languages as $language ){
			$contentDefault[$language['iso_code']] ="English";
		}
    ...
    */	
	...
	private function _getFormConfig(){
	    ...
	    ob_start();
	    include_once dirname(__FILE__).'/config/leocustomadvhtml.php'; 
