 ...
 * loftwitter Class
 */	
class leocustomhometop extends Module
{
	/**
    ...
    */
	function __construct(){
		$this->name = 'leocustomhometop';
		parent::__construct();			
		$this->author = 'leotheme';				
		$this->version = '1.1';
		$this->displayName = $this->l('Display Custom Home Top HTML');
    ...
    */	
	...
	private function _getFormConfig(){
	    ...
	    ob_start();
	    include_once dirname(__FILE__).'/config/leocustomhometop.php'; 
