            ...
            <div id="tabs-1">
                <div class="lof_config_wrrapper clearfix">
                    <ul>
                        ...
                        echo $this->_params->radioBooleanTag("show_title", $yesNoLang, $this->getParamValue("show_title", 1), $this->l('Show title'), 'class="select-option"', 'class="row"', '', $this->l('show/hide module title'));
            ...
            <div id="tabs-2">
                <div class="lof_config_wrrapper clearfix">
                    <ul>
                        ...
                        echo $this->_params->inputTag("main_height", $this->getParamValue("main_height", 350), $this->l('Main Image Height'), 'class="text_area"', 'class="row cre_main_size-1"', '');
                        echo $this->_params->inputTag("main_width", $this->getParamValue("main_width", 650), $this->l('Main Image Width'), 'class="text_area"', 'class="row cre_main_size-1"', '');
                        ...
                        echo $this->_params->inputTag("thumb_height", $this->getParamValue("thumb_height", 50), $this->l('Thumbnail Height'), 'class="text_area"', 'class="row"', '');
                        echo $this->_params->inputTag("thumb_width", $this->getParamValue("thumb_width", 50), $this->l('Thumbnail Width'), 'class="text_area"', 'class="row"', '');
                        ?>
                    </ul>
                </div>
            </div>
