    ...
    <div class="lof_config_wrrapper clearfix">
      <ul>
        <?php 
			...
			echo $this->_params->inputTag("title",$this->getParamValue("title","Lof Twitter"),$this->l('Title Module'),'class="text_area"','class="row"','');                                                
            ...
            echo $this->_params->inputTag("module_height",$this->getParamValue("module_height",130),$this->l('Module Height'),'class="text_area"','class="row"','');
        ?>                 
      </ul>
    </div>
  </fieldset>
    ...
    <div class="lof_config_wrrapper clearfix">
      <ul>
        <?php
            ...
            echo $this->_params->inputTag("limit_items",$this->getParamValue("limit_items",10),$this->l('Limit Items'),'class="text_area"','class="row"','','limit items');
			...
			echo $this->_params->selectTag("showMode",$arrshowMode,$this->getParamValue("showMode","ticker"),$this->l('Show Mode'),'class="inputbox select-group"', 'class="row"');               
