...
class Customers extends Admin_Controller {
	...
	function index($field='lastname', $by='ASC', $page=0)
	{
		...
		if($_SERVER['PATH_INFO'] = '/admin/customers'){
		$data['customers1']	= $this->Customer_model->get_customers1(50,$page, $field, $by);
		}else{
	...
	function export_xml()
	{
		...
		$data['customers'] = (array)$this->Customer_model->get_customers1();
    ...
    $data['link_goo'] = '';
		...
		{	
			...
			$data['id'] = $customer->id;
		    $data['quote'] = $customer->quote;
		    $data['bio'] = $customer->bio;
		    $data['email'] = $customer->email;
		    $data['username'] = $customer->username;
		    $data['firstname'] = $customer->firstname;
		    $data['lastname'] = $customer->lastname;
		    $data['cell_phone'] = $customer->cell_phone;
		    ...
		    $data['experiences'] = $customer->experiences;
		    $data['education'] = $customer->education;
		...
		foreach ($query->result() as $key) {
		    ...
		    $save['quote'] = $this->input->post('quote');
		    $save['bio'] = $this->input->post('bio');
		    $save['email'] = $this->input->post('email');
		    $save['username'] = $this->input->post('username');
		    $save['firstname'] = $this->input->post('firstname');
		    $save['lastname'] = $this->input->post('lastname');
		    $save['cell_phone'] = $this->input->post('cell_phone');
		    $save['birthday'] = $this->input->post('birthday');
		    ...
		    $save['experiences'] = $this->input->post('experiences');
		    $save['education'] = $this->input->post('education');
		    $save['question1'] = $this->input->post('question1');
		    $save['question2'] = $this->input->post('question2');
		    $save['question3'] = $this->input->post('question3');
		    $save['question4'] = $this->input->post('question4');
		    $save['question5'] = $this->input->post('question5');
		    $save['question6'] = $this->input->post('question6');
		    $save['question7'] = $this->input->post('question7');
		    $save['question8'] = $this->input->post('question8');
		    $save['question9'] = $this->input->post('question9');
		    $save['question10'] = $this->input->post('question10');
		    $save['question11'] = $this->input->post('question11');
		    $save['question12'] = $this->input->post('question12');
		    $save['question13'] = $this->input->post('question13');
		    $save['question14'] = $this->input->post('question14');
		    $save['link_face'] = $this->input->post('link_face');
		    $save['link_twit'] = $this->input->post('link_twit');
		    $save['link_goo'] = $this->input->post('link_goo');
	...
	{
				 // echo '<pre>';
				 $diferencia = $_SERVER['HTTP_REFERER'];
				 $conver = explode('/',$diferencia);

				 
	foreach($conver as $posicion=>$string)
	{
	...
	if($string == 'dashboard'){
		$subscribers = $this->Customer_model->get_subscribers1();
		}
