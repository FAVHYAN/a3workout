...
Class Category_model extends CI_Model
{
	...
	function get_categories($parent = false)
	{
        ...
        function get_category_shop($type){            
	...
	function category_autocomplete($name, $limit)
	{
     ...
     function category_autocomplete_courses_products($name, $limit, $type){

     
        	
            return	$query1 = $this->db->query("select * from categories c where c.slug like '".$name."' AND c.`type` ='".$type."'")->result();
        }
