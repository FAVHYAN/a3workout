   ...
   //slider cursos
      ...
      function cargar_datos(fecha,id_trainer2){
        ...
        var id_student = $("#customer_id").val();
          ...
          $.ajax({
                  data:  {id_trainer:id_trainer,id_student:id_student,horario:horario,id_trainer2:id_trainer2},
    ...
    function descriptionClass(valor1){
       ...
       $.ajax({
                  ...
                  success:  function (response) {
                      ...
                      $("#description").empty();
                      $.each(obj, function() {
                          var image = this['image_course'];
                          var name = this['name_course'];
                          var id_trainer = this['id_trainer'];
                          var name_trainer = this['firstname']+' '+this['lastname'];
                          var description = this['descrip_course'];
                          var id_student =  this['id_student'];
                          var id_course = this['id_course'];
                          var username = this['username'];
                          var type = this['tipo'];

                          var date  = this['date_course'];
                         ...
                         var hour = date.substr(11,9);

                         var date = mes+"-"+dia+"-"+ano+" "+hour;

                         hour = hour.replace(":","_");hour = hour.replace(":","_");
                         var fecha = ano+"_"+mes+"_"+dia+"_"+hour;
                       }
                         ...
                         if(type != 1){
                           $("#description").append("<div class='col-md-13' id='curso' style='height: 278px;margin: 0px 0 17px 0;height: 367px;'><div class='well box-profile' align='center' style='margin-top: 0!important;float: left;height: 362px;width: 659px;'><div style='margin:0 -3px 0 -19px;float: left;width:40%;'><img src='<?php echo base_url('uploads/images/thumbnails/"+images+"');?>' style='border: 10px solid #FFF;width:200px!important;border-color:#E7E7E7;border-radius: 6px;'><b><h3 class='text-bold'><h3>"+name+"</h3></b><b><h3 style='color: #e32322;'>"+date+"</h3><b><h5 style='color: #e32322;'><a onclick=\"location.href='http://www.a3workout.com/index.php/"+username+"'\"> by "+name_trainer+"</a></h3></div><p class='text-md-small' align='justify' style='font-size: 0.6em;margin: 89px 0 0 0;'>"+description+"</p><div id='popOverBox' style='color: #e32322;font-size:14px;font-weight:bold'></div><div id='popOverBox' style='color: Black;font-size:14px;'></div><div class='col-md-12' style='text-align:center'><button onclick=\"go_to_class_group('"+id_trainer+"','"+id_student+"','"+fecha+"');\" class='btn btn-primary' style='font-size: 11px;'>Go to class</button></div></div>"); 

                         }else{
                         $("#description").append("<div class='col-md-13' id='curso' style='height: 278px;margin: 0px 0 17px 0;height: 367px;'><div class='well box-profile' align='center' style='margin-top: 0!important;float: left;height: 362px;width: 659px;'><div style='margin:0 -3px 0 -19px;float: left;width:40%;'><img src='<?php echo base_url('uploads/images/thumbnails/"+images+"');?>' style='border: 10px solid #FFF;width:200px!important;border-color:#E7E7E7;border-radius: 6px;'><b><h3 class='text-bold'><h3>"+name+"</h3></b><b><h3 style='color: #e32322;'>"+date+"</h3><b><h5 style='color: #e32322;'><a onclick=\"location.href='http://www.a3workout.com/index.php/"+username+"'\"> by "+name_trainer+"</a></h3></div><p class='text-md-small' align='justify' style='font-size: 0.6em;margin: 89px 0 0 0;'>"+description+"</p><div id='popOverBox' style='color: #e32322;font-size:14px;font-weight:bold'></div><div id='popOverBox' style='color: Black;font-size:14px;'></div><div class='col-md-12' style='text-align:center'><button onclick=\"go_to_class('"+id_trainer+"','"+id_student+"','"+fecha+"','"+name_trainer+"');\" class='btn btn-primary' style='font-size: 11px;'>Go to class</button></div></div><br>"); 
                          ...
                          <div class="col-md-4 classbor">
                              ...
                              <div class="container" style="padding-left: 0;">
                                 <div class="pull-right">
                                      ...
                                      <div align="right">
                              <a class="btn btn-success" data-toggle="modal" data-target="#modal_calendar"  data-id="<?php echo $courses->id_trainner.",".$courses->id_course.",".$courses->type;?>"   onclick = "two('<?php echo $courses->type;?>','<?php echo $date; ?>','<?php echo $courses->id_trainner?>','<?php echo $courses->id_course;?>')">Enroll</a>
