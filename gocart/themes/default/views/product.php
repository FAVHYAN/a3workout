    ...
    <div class="container zero-margin zero-padding">
		<div class="row" style="margin: 3em 1em;">
			...
			<div class="col-md-9">
				<div class="row">
					<div class="col-md-12" align="center">
						...
						if(!empty($product->images[0]))
						{
							...
							$photo	= '<img class="responsiveImage" src="'.base_url('uploads/images/medium/'.$primary->filename).'" alt="'.$product->seo_title.'" width="200" style="width: auto;"/>';
						}
						echo $photo
						?>
					</div>
				...
				<div class="row">
					<div class="col-md-6" id="product_caption">
				...
				<div class="row" style="margin-top:15px; text-align: justify;">
					<div class="col-md-12">
						<?php echo $product->description; ?>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6 sku-pricing">
					...
					<div class="col-md-6 out-of-stock">
						<div><?php echo lang('out_of_stock');?></div>
					</div>
					<?php endif;?>
				</div>
				<div class="well" style="margin-bottom: 15px; margin-top: 15px;">
					<?php echo form_open('cart/add_to_cart', 'class="form-horizontal"');?>
						...
						<?php if(!config_item('inventory_enabled') || config_item('allow_os_purchase') || !(bool)$product->track_stock || $product->quantity > 0) : ?>
							<?php if($product->quantity > 0) : ?>
								<div class="control-group">
									<label class="pull-left" style="margin-right: 10px;"><?php echo lang('quantity') ?></label>
									<input class="form-control pull-left" style="width: 20%; margin-right: 10px;" type="text" name="quantity" value=""/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<button class="btn btn-primary btn-lg pull-left" type="submit" value="submit"><i class="icon-shopping-cart icon-white"></i> <?php echo lang('form_add_to_cart');?></button>
								</div>
							<?php endif; ?>
						<?php endif;?>
							...
							<?php foreach($product->related_products as $relate):?>
								<li class="col-md-2 product">
									...
									if(!empty($relate->images[0]))
									{
										...
										$photo	= '<img src="'.base_url('uploads/images/thumbnails/'.$primary->filename).'" alt="'.$relate->seo_title.'" width="100"/>';
									}
									?>
