				...
				<?php include('checkout/summary.php');?>
					...
					<div class="col-md-5">
					    ...
					    <div class="input-group">
					    	<input type="text" name="coupon_code" class="form-control">
						      <span class="input-group-btn">
						        <button class="btn btn-default" type="submit"><?php echo lang('apply_coupon');?></button>
						      </span>
					    </div><!-- /input-group -->
						...
						<?php if($gift_cards_enabled):?>
							...
							<input type="text" name="gc_code" class="col-md-3" style="margin:0px;">
							<input class="col-md-2 btn"  type="submit" value="<?php echo lang('apply_gift_card');?>"/>
						<?php endif;?>
					</div>
					...
					<div class="col-md-7" style="text-align:right;">
						...
						<?php if ($cart_contents['customer']['id'] || !$this->config->item('require_login')): ?>
