                ...
                <div class="row">
                    <div class="span">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="email" id="email"  placeholder="Enter E-mail" disabled>
                        </div>
                        <div class="form-group">
                        ...
                        <div>
                            ...
                            <input type="numeric" class="form-control" name="cellphone" id="cellphone" placeholder="Enter Cell Phone">
                        </div>
                        <div class="form-group">
