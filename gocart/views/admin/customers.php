...
<div class="btn-group pull-right">
	<a class="btn" href="<?php echo site_url($this->config->item('admin_folder').'/customers/export_xml');?>"><i class="icon-download"></i>  Export Trainers or consultant(XML)</a>
	...
	<a class="btn" href="<?php echo site_url($this->config->item('admin_folder').'/customers/form'); ?>"><i class="icon-plus-sign"></i> Add new Trainer or consultant</a>
</div>
...
<table class="table table-striped">
	...
	<tbody>
		...
		if($page_links != ''):?>
		<tr><td style="text-align:center">Type</td><td colspan="5" style="text-align:center"><?php echo $page_links;?></td></tr>
		<?php endif;?>

		<?php
		echo (count($customers1) < 1)?'<tr><td style="text-align:center">Type</td><td style="text-align:center;" colspan="5">'.lang('no_customers').'</td></tr>':''?>
