...
<div class="row">
	<div class="span12" style="text-align:center;">
		...
		<a class="btn btn-large" href="<?php echo site_url($this->config->item('admin_folder').'/customers/get_subscriber_list');?>"><i class="icon-download"></i> <?php echo lang('subscriber_download');?> Opt-in Emails (CSV)</a>
	</div> 
