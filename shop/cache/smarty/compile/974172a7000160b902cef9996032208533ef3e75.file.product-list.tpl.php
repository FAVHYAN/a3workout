<?php /* Smarty version Smarty-3.1.13, created on 2013-12-06 11:28:05
         compiled from "/var/www/vhosts/www.a3workout.com/httpdocs/product_shop/themes/leometr/product-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:91894036252a1fb15aba3f5-05365330%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '974172a7000160b902cef9996032208533ef3e75' => 
    array (
      0 => '/var/www/vhosts/www.a3workout.com/httpdocs/product_shop/themes/leometr/product-list.tpl',
      1 => 1386266053,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '91894036252a1fb15aba3f5-05365330',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52a1fb15c13629_96486225',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52a1fb15c13629_96486225')) {function content_52a1fb15c13629_96486225($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/vhosts/www.a3workout.com/httpdocs/product_shop/tools/smarty/plugins/modifier.escape.php';
?>
...
?>
		...
		<div class="p-item myspan<?php echo (12/Configuration::get('productlistcols'));?>
 product_block ajax_block_product <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['products']['first']){?>first_item<?php }elseif($_smarty_tpl->getVariable('smarty')->value['foreach']['products']['last']){?>last_item<?php }?> <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['products']['index']%2){?>alternate_item<?php }else{ ?>item<?php }?> clearfix">
...
">
									<img src="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'home_leometr');?>
...
"<?php }?> />
							...
							<div class="right_block">
								<h3 class="s_title_block"><a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value['link'], 'htmlall', 'UTF-8');?>
...
"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value['name'], 'htmlall', 'UTF-8'),35,'...');?>
								...
								<div class="product_desc"><a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value['link'], 'htmlall', 'UTF-8');?>
...
<?php }?></span><?php }?>
								...
								<span class="online_only"><?php if (isset($_smarty_tpl->tpl_vars['product']->value['online_only'])&&$_smarty_tpl->tpl_vars['product']->value['online_only']){?><?php echo smartyTranslate(array('s'=>'Online only!'),$_smarty_tpl);?>
<?php }?></span>
								<?php }?>
