<?php /* Smarty version Smarty-3.1.13, created on 2013-12-09 12:24:53
         compiled from "/var/www/vhosts/www.a3workout.com/httpdocs/shop/modules/blockwishlist/views/templates/front/mywishlist.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14403503252a5fce5a00ee2-31122376%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a0710326b8fc632cd743b2996fbd64ac159c6d6b' => 
    array (
      0 => '/var/www/vhosts/www.a3workout.com/httpdocs/shop/modules/blockwishlist/views/templates/front/mywishlist.tpl',
      1 => 1386265702,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14403503252a5fce5a00ee2-31122376',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52a5fce5b19f77_11726070',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52a5fce5b19f77_11726070')) {function content_52a5fce5b19f77_11726070($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/vhosts/www.a3workout.com/httpdocs/shop/tools/smarty/plugins/modifier.escape.php';
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
	...
	<h2><?php echo smartyTranslate(array('s'=>'My wishlists','mod'=>'blockwishlist'),$_smarty_tpl);?>
</h2>
	...
	<?php if (intval($_smarty_tpl->tpl_vars['id_customer']->value)!=0){?>
		<form method="post" class="std" id="form_wishlist">
			<fieldset>
				<h3><?php echo smartyTranslate(array('s'=>'New wishlist','mod'=>'blockwishlist'),$_smarty_tpl);?>
</h3>
				<p class="text">
					<input type="hidden" name="token" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['token']->value, 'htmlall', 'UTF-8');?>
" />
					<label class="align_right" for="name"><?php echo smartyTranslate(array('s'=>'Name','mod'=>'blockwishlist'),$_smarty_tpl);?>
</label>
					<input type="text" id="name" name="name" class="inputTxt" value="<?php if (isset($_POST['name'])&&count($_smarty_tpl->tpl_vars['errors']->value)>0){?><?php echo smarty_modifier_escape($_POST['name'], 'htmlall', 'UTF-8');?>
<?php }?>" />
				</p>
				<p class="submit">
...
');"><?php echo smarty_modifier_escape($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['wishlists']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['name'],30,'...'), 'htmlall', 'UTF-8');?>
</a>
						</td>
...
'));"><?php echo smartyTranslate(array('s'=>'Delete','mod'=>'blockwishlist'),$_smarty_tpl);?>
</a>
						</td>
					</tr>
				<?php endfor; endif; ?>
...
"><?php echo smartyTranslate(array('s'=>'Back to Your Account','mod'=>'blockwishlist'),$_smarty_tpl);?>
</a></li>
...
"><?php echo smartyTranslate(array('s'=>'Home','mod'=>'blockwishlist'),$_smarty_tpl);?>
</a></li>
	</ul>
</div>
<?php }} ?>