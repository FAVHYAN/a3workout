<?php /* Smarty version Smarty-3.1.13, created on 2013-12-09 11:58:04
         compiled from "/var/www/vhosts/www.a3workout.com/httpdocs/shop/themes/leometr/order-payment.tpl" */ ?>
<?php /*%%SmartyHeaderCode:181208492152a5f69c87fe80-30405206%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bc4971649f6ace544ab50d176ce7f8273b04a16e' => 
    array (
      0 => '/var/www/vhosts/www.a3workout.com/httpdocs/shop/themes/leometr/order-payment.tpl',
      1 => 1386266050,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '181208492152a5f69c87fe80-30405206',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52a5f69cb5d916_45080403',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52a5f69cb5d916_45080403')) {function content_52a5f69cb5d916_45080403($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/vhosts/www.a3workout.com/httpdocs/shop/tools/smarty/plugins/modifier.escape.php';
?>
...
<?php if (!$_smarty_tpl->tpl_vars['opc']->value){?><h1 class="title_category"><?php echo smartyTranslate(array('s'=>'Choose your payment method'),$_smarty_tpl);?>
	...
	<table id="cart_summary" class="std">
		<thead>
			<tr>
				...
				<th class="cart_availability item hidden-phone"><?php echo smartyTranslate(array('s'=>'Avail.'),$_smarty_tpl);?>
</th>
...
<?php $_tmp2=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete&amp;id_product=".$_tmp1."&amp;ipa=".$_tmp2."&amp;id_customization=".((string)$_smarty_tpl->tpl_vars['id_customization']->value)."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value));?>
...
<?php $_tmp4=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add&amp;id_product=".$_tmp3."&amp;ipa=".$_tmp4."&amp;id_customization=".((string)$_smarty_tpl->tpl_vars['id_customization']->value)."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value));?>
...
<?php $_tmp6=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add&amp;id_product=".$_tmp5."&amp;ipa=".$_tmp6."&amp;id_customization=".((string)$_smarty_tpl->tpl_vars['id_customization']->value)."&amp;op=down&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value));?>
