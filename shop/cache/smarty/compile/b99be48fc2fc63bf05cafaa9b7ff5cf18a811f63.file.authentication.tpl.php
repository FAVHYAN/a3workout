<?php /* Smarty version Smarty-3.1.13, created on 2013-12-06 17:40:48
         compiled from "/var/www/vhosts/www.a3workout.com/httpdocs/shop/themes/leometr/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8202404352a252700452a7-76913009%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b99be48fc2fc63bf05cafaa9b7ff5cf18a811f63' => 
    array (
      0 => '/var/www/vhosts/www.a3workout.com/httpdocs/shop/themes/leometr/authentication.tpl',
      1 => 1386266040,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8202404352a252700452a7-76913009',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52a25270437a07_33447551',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52a25270437a07_33447551')) {function content_52a25270437a07_33447551($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/vhosts/www.a3workout.com/httpdocs/shop/tools/smarty/plugins/modifier.escape.php';
?>
...
<form action="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true);?>
" method="post" id="account-creation_form" class="std form-horizontal">
...
" <?php if (isset($_POST['id_gender'])&&$_POST['id_gender']==$_smarty_tpl->tpl_vars['gender']->value->id){?>checked="checked"<?php }?> />
		...
		<div class="control-group">
			<label for="customer_firstname" class="control-label"><?php echo smartyTranslate(array('s'=>'First name'),$_smarty_tpl);?>
 <sup>*</sup></label>
			<div class="controls">
                <input onkeyup="$('#firstname').val(this.value);" type="text" class="text input-xlarge" id="customer_firstname" name="customer_firstname" value="<?php if (isset($_POST['customer_firstname'])){?><?php echo $_POST['customer_firstname'];?>
<?php }?>" />
            </div>
		</div>
        <div class="control-group">
			<label for="customer_lastname" class="control-label"><?php echo smartyTranslate(array('s'=>'Last name'),$_smarty_tpl);?>
 <sup>*</sup></label>
            <div class="controls">
			    <input onkeyup="$('#lastname').val(this.value);" type="text" class="text input-xlarge" id="customer_lastname" name="customer_lastname" value="<?php if (isset($_POST['customer_lastname'])){?><?php echo $_POST['customer_lastname'];?>
<?php }?>" />
            </div>
		</div>
        <div class="control-group">
			<label for="email" class="control-label"><?php echo smartyTranslate(array('s'=>'E-mail'),$_smarty_tpl);?>
 <sup>*</sup></label>
            <div class="controls">
			    <input type="text" class="text input-xlarge" id="email" name="email" value="<?php if (isset($_POST['email'])){?><?php echo $_POST['email'];?>
<?php }?>" />
            </div>
		</div>
        <div class="control-group">
			<label class="control-label" for="passwd"><?php echo smartyTranslate(array('s'=>'Password'),$_smarty_tpl);?>
 <sup>*</sup></label>
            <div class="controls">
