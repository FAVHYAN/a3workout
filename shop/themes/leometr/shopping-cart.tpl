...
<h1 id="cart_title" class="title_category">{l s='Shopping cart summary'}</h1>
...
{if isset($lastProductAdded) AND $lastProductAdded}
	<div class="cart_last_product">
		...
		<a  class="cart_last_product_img" href="{$link->getProductLink($lastProductAdded.id_product, $lastProductAdded.link_rewrite, $lastProductAdded.category, null, null, $lastProductAdded.id_shop)|escape:'htmlall':'UTF-8'}"><img src="{$link->getImageLink($lastProductAdded.link_rewrite, $lastProductAdded.id_image, 'small_leometr')}" alt="{$lastProductAdded.name|escape:'htmlall':'UTF-8'}"/></a>
