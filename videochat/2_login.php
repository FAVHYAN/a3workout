...
?>fixOutput=decoy&server=<?=$rtmp_server?>&serverAMF=<?=$rtmp_amf?>&serverProxy=best&serverRTMFP=<?=$rtmfp_server?>&room=<?=urlencode($room)?>&welcome=<?=urlencode($welcome)?>&username=<?=$username?>&msg=<?=$message?>&loggedin=<?=$loggedin?>&showTimer=1&showCredit=1&disconnectOnTimeout=0&camWidth=320&camHeight=240&camFPS=15&camBandwidth=40960&limitByBandwidth=1&camPicture=0&showCamSettings=1&camMaxBandwidth=81920&disableBandwidthDetection=1&disableUploadDetection=1&verboseLevel=4&disableVideo=0&disableSound=0&bufferLive=0.1&bufferFull=0.1&bufferLivePlayback=0.1&bufferFullPlayback=0.1&videoCodec=H264&codecProfile=main&codecLevel=3.1&soundCodec=Speex&soundQuality=9&micRate=22&silenceLevel=0&silenceTimeout=0&micGain=50&filterRegex=<?=$filterRegex?>&filterReplace=<?=$filterReplace?>&disableEmoticons=0&showTextChat=1&sendTextChat=1&webfilter=0&enableP2P=1&enableServer=1&configureConnection=1&configureSource=1&enableNext=1&enableBuzz=1&enableSoundFx=1&requestSnapshot=1&enableButtonLabels=1&enableFullscreen=1&enableSwap=1&enableLogout=1&enableLogo=1&enableHeaders=1&enableTitles=1&videoW=480&videoH=365&video2W=480&video2H=365&layoutCode=<?=urlencode($layoutCode)?>&chatTextColor=<?=$chatTextColor?>&autoSnapshots=1&snapshotsTime=20000&adServer=<?=urlencode('2_ads.php')?>&adsInterval=0&adsTimeout=0&loadstatus=1